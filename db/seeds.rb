...
2.times do |i|
  patient = Patient.new
  patient.name = "marvin#{i+20}"
  patient.cpf = vaccineted_cpfs[i]
  patient.mother_name = 'Tristeza'
  ...
  second_appointment = Appointment.create(
    ...
    second_dose: true,
    vaccine_name: 'coronavac',
    check_in: second_appointment_start + time_multiplier,
    check_out: second_appointment_start + 10.minutes + time_multiplier,
    active: true,
    ubs: ubs
  )
