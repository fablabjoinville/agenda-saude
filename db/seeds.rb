...
[
  { id: 23, name: 'Trabalhador(a) da Saúde', position: 0 },
  { id: 24, name: 'Trabalhador(a) da Educação', position: 1 },
  ...
  { id: 998, name: 'Não me encaixo em nenhum dos grupos listados', position: 15 },

  # Comorbidity:

  { id: 41, name: 'Doença renal crônica', context: 1, position: 50 },
  ...
  { id: 36, name: 'Diabetes mellitus', context: 1, position: 51 },

  { id: 37, name: 'Pneumopatias graves', context: 1, position: 52 },
  ...
  { id: 38, name: 'Hipertensão', context: 1, position: 53 },
  ...
  { id: 39, name: 'Doenças cardiovasculares', context: 1, position: 54 },
  ...
  { id: 40, name: 'Doença cerebrovascular', context: 1, position: 55 },
  ...
  { id: 42, name: 'Imunossuprimidos', context: 1, position: 56 },
  ...
  { id: 92, name: 'Gestantes e puérperas com comorbidades', context: 1, position: 57 },
  { id: 93, name: 'Gestantes e puérperas sem comorbidades', context: 1, position: 58 },
  { id: 94, name: 'Pessoas com deficiências permanentes cadastradas no Programa de Benefício de Prestação Continuada (BPC)', context: 1, position: 59 },
  { id: 95, name: 'Cirrose Hepática - (Child-Pugh A, B ou C)', context: 1, position: 60 },
  { id: 43, name: 'Anemia falciforme', context: 1, position: 61 },
  { id: 44, name: 'Obesidade mórbida (IMC >=40)', context: 1, position: 62 },
  { id: 45, name: 'Síndrome de down', context: 1, position: 63 },
  { id: 999, name: 'Não possuo nenhuma das comorbidades ou a que tenho, não está na lista', context: 1, position: 64 },
